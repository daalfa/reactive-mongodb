...
//        var restaurantDTO = new RestaurantResponseDTO(null, null, null, null, null);
//
...
//
//        Flux<RestaurantResponseDTO> response = restaurantService.getRestaurants(Map.of(
//                "name", VALID_TEXT,
//                "price", "+1.0",
//                "rating", "4.",
//                "distance", ".2",
...
//        map.put(name, value);
//        Flux<RestaurantResponseDTO> response = restaurantService.getRestaurants(map);
//
//        StepVerifier.create(response)
//                .expectErrorSatisfies(throwable -> assertThat(throwable)
//                        .isInstanceOf(ValidationException.class)
